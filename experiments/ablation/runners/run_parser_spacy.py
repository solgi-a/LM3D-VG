"""
Parser ablation, variant B -- rule-based spaCy dependency parser.

Build the parse cache first (~1 minute on CPU), then train:

    python experiments/ablation/parsers/run_spacy_parser.py --splits train val
    python experiments/ablation/runners/run_parser_spacy.py
"""
...
TAG = "ABL-PARSER-SPACY"                      # output folder suffix under outputs/
PARSING_FOLDER = "spacy_parsing_tokenized"    # variant B: rule-based spaCy
