...
class ScannetDatasetConfig(object):
    def __init__(self):
        ...
        self.nyu40id2class = self._get_nyu40id2class() ## convert 40 class id to 18 class id
        ...
        self.num_heading_bin = 1 ## number of bins for approximating angle or heading of an object
    ...
    def size2class(self, size, type_name):
        ''' Convert 3D box size (l,w,h) to size class and size residual ''' ## compare a object size to mean size of it's class 
