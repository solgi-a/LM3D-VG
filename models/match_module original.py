...
class MatchModule(nn.Module):
    def __init__(self, args, num_proposals=256, hidden_size=128, det_channel=288, head=4, depth=2):
        ...
        self.tgt_cross_attn = MultiHeadAttention(d_model=hidden_size, d_k=hidden_size // head, d_v=hidden_size // head, h=head)

        self.adj_cross_attn = MultiHeadAttention(d_model=hidden_size, d_k=hidden_size // head, d_v=hidden_size // head, h=head)

        self.ngh_cross_attn = MultiHeadAttention(d_model=hidden_size, d_k=hidden_size // head, d_v=hidden_size // head, h=head)
