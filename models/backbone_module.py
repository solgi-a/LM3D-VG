...
# original Python reference. Each tier is tried only when the one above it cannot be
# imported. ABLATION.POINTNET_IMPL pins one tier by name; unset walks the chain.
