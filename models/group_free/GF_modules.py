...
try:
    ...
    # NOT the three-tier chain. pointnet2_py_adv.gather_operation takes (B, N, C)
    # while this file passes channel-first (B, C, N) tensors, as the CUDA and
    # pointnet2_python versions expect -- substituting it here would silently
    # produce wrong features rather than fail. Only these two are interchangeable.
    from pointnet.pointnet2_python import pointnet2_utils
